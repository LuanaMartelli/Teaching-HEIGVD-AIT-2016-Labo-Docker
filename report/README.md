...
5. <a name="M5"></a>**[M5]** __In the physical or virtual machines of a
   ...
   <a name="M1"></a>**[A5]** Severs cannot talk to each other or to 
   the load balancer. Therefore, we cannot implement a way to make them 
   log or to implement another process. We should first be able to make
   them communicate one to another. 
